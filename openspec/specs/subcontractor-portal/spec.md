# subcontractor-portal Specification

## Purpose

Give a signed-in subcontractor a narrow view of just the orders they are assigned to, and nothing else in the contractor's account. What they see and whether they can write is governed by their Tier: a Guest Contractor gets a read-only view with the customer's contact PII redacted server-side, while a Trusted Subcontractor sees the full order and can post timeline notes and job photos.
